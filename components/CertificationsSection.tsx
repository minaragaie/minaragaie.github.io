...
export default function CertificationsSection({ isVisible = false }: CertificationsSectionProps) {
  ...
  useEffect(() => {
    const checkMobile = () => {
      // Access window.innerWidth here, where it is safe to use.
    ...
    // Add a resize listener to handle window size changes dynamically
    ...
    <div className="max-w-6xl mx-auto">
      <div className="text-center mb-8 sm:mb-16">
        <h2 className="text-2xl sm:text-4xl font-bold mb-4" style={{ color: "var(--certificates-text-primary)" }}>
          <span className="font-mono" style={{ color: "var(--certificates-text-code)" }}>const</span>{" "}
          <span style={{ color: "var(--certificates-color-cyan)" }}>certifications</span>{" "}
          <span style={{ color: "var(--certificates-text-primary)" }}>=</span>{" "}
          <span style={{ color: "var(--certificates-text-string)" }}>[]</span>
        </h2>
                ...
                {cert.skills.length > 0 && (
                  <div className="mb-3 sm:mb-4">
                    ...
                    <div className="flex flex-wrap gap-1 sm:gap-2">
                      {cert.skills
                        .slice(0, isMobile ? 4 : cert.skills.length)
